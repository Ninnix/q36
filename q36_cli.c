...
static void usage(FILE *fp) {
    fprintf(fp,
        ...
        "  --top-k N\n"
        "      Keep only the top-k logits before sampling. 0 disables the cap. Default: 0\n"
        "  --top-p F\n"
        "      Nucleus sampling probability. 1 disables it. Default: 1\n"
        "  --min-p F\n"
        "      Drop tokens below a minimum relative probability floor. Default: 0.05\n"
        "  --seed N\n"
